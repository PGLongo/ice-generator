# GEMINI.md - CareCard Project Documentation
...
└── GEMINI.md                            # This file - AI assistant context
```
...
**CRITICAL: ALWAYS use the `nuxt-dev-expert` agent for ALL project management tasks:**
...
**Workflow Rules:**
1. **Never manually create GitHub issues** - Always delegate to `nuxt-dev-expert` agent
...
**MANDATORY nuxt-dev-expert Agent Requirements:**
...
**IMPORTANT: Use `nuxt-dev-expert` agent to convert these to proper GitHub issues**
...
**Backlog Management Note**: All pending features should be tracked as Epics or User Stories in the GitHub project board. Use the `nuxt-dev-expert` agent to:
